...
#import "CheckManTableViewController.h"
#import "WLMyJournal.h"
#import "ResultAViewController.h"


@interface CheckManTableViewController ()

@end

@implementation CheckManTableViewController
...
- (void)viewDidLoad
{
    ...
    WLSectionHeaderView *make = [[WLSectionHeaderView alloc] initWithFrame:CGRectMake(0.0, 0.0, 320, HEADER_HEIGHT) title:nil section:0 delegate:self numrow:0 withManOrWomen:1];
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    UIImage *img = [UIImage imageNamed:@"topbar_check_3.png"];
    ...
    ALAssetsLibrary *al = [CheckManTableViewController defaultAssetsLibrary];
...
-(void)loadData
{
    ...
    for (id key in self.dataDict) {
        ...
        WLSectionHeaderView *make = [[WLSectionHeaderView alloc] initWithFrame:CGRectMake(0.0, 0.0, 320, HEADER_HEIGHT) title:key section:sectionNr delegate:self numrow:[anObject count] withManOrWomen:1];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (indexPath.section == 1 && indexPath.row == 0) {
        ...
        label.text = [NSString stringWithFormat:@"ペニス かゆみ"];
    } else if (indexPath.section == 5 && indexPath.row == 3) {
        label.text = [NSString stringWithFormat:@"ペニス いたみ"];
    } else if (indexPath.section == 5 && indexPath.row == 4) {
        label.text = [NSString stringWithFormat:@"ペニス イボ"];
    } else if (indexPath.section == 5 && indexPath.row == 5) {
        label.text = [NSString stringWithFormat:@"ペニス 水泡　ただれ"];
    } else if (indexPath.section == 5 && indexPath.row == 6) {
        label.text = [NSString stringWithFormat:@"亀頭 かゆみ"];
    } else if (indexPath.section == 5 && indexPath.row == 7) {
        label.text = [NSString stringWithFormat:@"亀頭 いたみ"];
    } else if (indexPath.section == 5 && indexPath.row == 8) {
        label.text = [NSString stringWithFormat:@"亀頭 白いカス"];
    } else if (indexPath.section == 5 && indexPath.row == 9) {
        label.text = [NSString stringWithFormat:@"亀頭 ただれ"];
    } else if (indexPath.section == 5 && indexPath.row == 10) {
        label.text = [NSString stringWithFormat:@"亀頭 イボ"];
    } else if (indexPath.section == 5 && indexPath.row == 11) {
        label.text = [NSString stringWithFormat:@"陰嚢 かゆみ"];
    } else if (indexPath.section == 5 && indexPath.row == 12) {
        label.text = [NSString stringWithFormat:@"陰嚢 いたみ"];
    } else if (indexPath.section == 5 && indexPath.row == 13) {
        label.text = [NSString stringWithFormat:@"陰嚢 イボ"];
        ...
        label.text = [NSString stringWithFormat:@"射精時 いたみ"];
    } else if (indexPath.section == 5 && indexPath.row == 22) {
        label.text = [NSString stringWithFormat:@"勃起時 いたみ"];
    } else if (indexPath.section == 6 && indexPath.row == 0) {
        label.text = [NSString stringWithFormat:@"尿 残尿感"];
        ...
        label.text = [NSString stringWithFormat:@"XXXXXXXXXXX"];
    }
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    if ([[segue identifier] isEqualToString:@"showResultMan"]) {
        ResultAViewController *vcntl = [segue destinationViewController];           // <- 1
        vcntl.manWoman = TRUE;                                                      // <- man
